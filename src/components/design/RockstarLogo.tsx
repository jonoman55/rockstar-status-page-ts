...
export const RockstarLogo = (props: Props) => (
    <svg
    ...
    >
        <g data-name="Layer 2">
            <g data-name="Layer 1">
                <path d="M214.55 197.37a4.94 4.94 0 1 1 1.45 -3.5 4.75 4.75 0 0 1 -1.45 3.5Zm-6.52 -6.5a4.27 4.27 0 0 0 0 6 4.25 4.25 0 0 0 6 0 4.26 4.26 0 0 0 -6 -6Zm2.92 0.27a4.24 4.24 0 0 1 1.5 0.2 1.36 1.36 0 0 1 0.84 1.38 1.17 1.17 0 0 1 -0.53 1.08 2.45 2.45 0 0 1 -0.78 0.26 1.32 1.32 0 0 1 0.93 0.52 1.57 1.57 0 0 1 0.3 0.84v0.8a1.2 1.2 0 0 0 0 0.28v0.07h-0.89v-0.66c0 -0.63 -0.17 -1.05 -0.52 -1.24a2.45 2.45 0 0 0 -1.07 -0.17H210v2.12h-0.95v-5.43Zm1 0.89a2.38 2.38 0 0 0 -1.16 -0.2H210v1.94h0.87a2.48 2.48 0 0 0 0.93 -0.13 0.94 0.94 0 0 0 0.2 -1.64Z" />
                ...
                />
                <path d="M185.49 118.2h-27.06l-4.29 -27 -15.86 26.8h-3a23.14 23.14 0 0 1 -2.52 -10.42c0 -4.6 0.34 -9.1 0.34 -15 0 -7.76 -2.28 -11.92 -8.37 -13.38V79c12.94 -1.8 18.81 -10.36 18.81 -22.42 0 -17.12 -11.39 -20.84 -26.32 -20.84H77.08l-17 80.4h21.37l6.18 -29.25h14.19c7.57 0 10.67 3.7 10.67 10.79 0 5.39 -0.56 9.66 -0.56 13.81 0 1.54 0.35 5.11 1.38 6.49l15.43 16.29 -13.27 28.55L143.86 146 165 162.23l-4 -26.93ZM108.2 71.86h-17l4.1 -19.38h15.79c5.62 0 11.46 1.46 11.46 8.34 0 8.67 -6.65 11.04 -14.35 11.04Z" />
                <path
                    style={{
                        fill: "#fff",
                    }}
